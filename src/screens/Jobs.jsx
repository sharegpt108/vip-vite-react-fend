...
function Jobs() {
  const jobCategories = [
    { title: 'Tech Jobs', description: 'Software development, IT support, and more.' },
    { title: 'Retail Opportunities', description: 'Work with Amazon, Flipkart, and Zomato.' },
    { title: 'Skill-Based Roles', description: 'Training and jobs via Tata Strive.' },
  ];
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 via-indigo-950 to-purple-950 min-h-screen py-20 px-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        >
          <circle cx="50" cy="50" r="45" stroke="url(#jobGrad1)" strokeWidth="5" strokeDasharray="15 15" />
          <defs>
            <linearGradient id="jobGrad1" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        >
          ...
          />
          <defs>
            <linearGradient id="jobGrad2" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <p className="text-xl text-gray-200 mb-16 max-w-3xl mx-auto leading-relaxed font-medium drop-shadow-md">
          Unlock a universe of opportunities designed for rural visionaries, powered by elite partnerships.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto relative z-10 space-y-12">
        {jobCategories.map((job, index) => (
          ...
          >
            ...
            <h3 className="relative z-10 text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-pink-400 mb-4 drop-shadow-md">
              {job.title}
            </h3>
            <p className="relative z-10 text-gray-200 text-lg font-medium">{job.description}</p>
            {/* Subtle Accent */}
      ...
      <div className="text-center mt-20 relative z-10">
        ...
        >
          <span className="relative z-10 drop-shadow-md">Launch Your Journey</span>
